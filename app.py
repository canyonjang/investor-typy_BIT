...
ALL_QUESTIONS = [
    ...
    {"id": "p6", "part": "Part 1.", "q": "6. 두 가지 포트폴리오 중 하나를 고른다면?", "options": {"주식 80%, 채권 20%": 1, "주식 40%, 채권 60%": 0}},
    {"id": "p7", "part": "Part 1.", "q": "7. 당신의 부의 목표는 무엇입니까?", "options": {"생활 수준을 희생해서라도 큰 자산 축적": 1, "편안한 생활 수준 유지": 0}},
    {"id": "p8", "part": "Part 1.", "q": "8. 사회생활이나 공부를 할 때 당신은 주로 스스로 일을 찾아 하는 편입니까, 아니면 가이드라인을 따르는 편입니까?", "options": {"자기 주도형": 1, "가이드라인 선호": 0}},
    {"id": "p9", "part": "Part 1.", "q": "9. 투자 시 무엇에 더 매력을 느깁니까?", "options": {"큰 수익을 위해 자본을 위험에 노출하기": 1, "정기적이고 안정적인 수익 창출": 0}},
    {"id": "p10", "part": "Part 1.", "q": "10. 대출을 활용한 투자(레버리지)에 대해 어떻게 생각합니까?", "options": {"부를 불리는 유용한 도구다": 1, "가급적 피해야 할 위험한 일이다": 0}},
    ...
    {"id": "r1", "part": "Part 2.", "q": "1. 주변 친구들은 당신을 어떤 사람으로 보나요?", "options": {"도박꾼": 4, "철저한 조사 후 위험 감수": 3, "신중함": 2, "위험 회피": 1}},
    {"id": "r2", "part": "Part 2.", "q": "2. 상금이 걸린 퀴즈쇼에서 하나를 고른다면?", "options": {"현금 100만 원 그냥 받기": 1, "50% 확률 500만 원": 2, "25% 확률 1,000만 원": 3, "5% 확률 1억 원": 4}},
    {"id": "r3", "part": "Part 2.", "q": "3. 아르바이트비를 모아 여행 가려는데, 갑자기 노트북이 고장 났습니다.", "options": {"여행 취소": 1, "저렴한 여행으로 변경": 2, "예정대로 가고 노트북은 나중에 고민": 3, "어차피 돈 나갈 거 더 좋은 곳으로 여행 감": 4}},
    {"id": "r4", "part": "Part 2.", "q": "4. 2,600만 원의 종잣돈이 생겼다면 어디에 넣겠습니까?", "options": {"예금/CD": 1, "안전한 우량 채권": 2, "주식형 펀드": 3}},
    {"id": "r5", "part": "Part 2.", "q": "5. 주식 투자를 하는 것에 대해 얼마나 심리적으로 편안함을 느깁니까?", "options": {"전혀 느끼지 못함": 1, "어느 정도 느낌": 2, "매우 편안함": 3}},
    {"id": "r6", "part": "Part 2.", "q": "6. '투자 위험'이라는 단어를 들으면 무엇이 떠오릅니까?", "options": {"손실": 1, "불확실성": 2, "기회": 3, "전율": 4}},
    {"id": "r7", "part": "Part 2.", "q": "7. 전문가들이 가상자산이나 부동산 급등을 예측합니다. 당신은 전액 예금에 있습니다.", "options": {"그대로 유지": 1, "절반만 투자": 2, "전액 투자": 3, "대출까지 받아 투자": 4}},
    {"id": "r8", "part": "Part 2.", "q": "8. 다음 수익 구조 중 무엇이 가장 마음에 드나요?", "options": {"200만원 이익 / 손실 없음": 1, "800만원 이익 / 200만원 손실 가능": 2, "2,600만원 이익 / 800만원 손실 가능": 3, "4,800만원 이익 / 2,400만원 손실 가능": 4}},
    {"id": "r9", "part": "Part 2.", "q": "9. 당신에게 공짜로 100만 원이 생겼다고 가정해 봅시다. 이때 다음 중 하나를 반드시 선택해야 한다면 무엇을 고르겠습니까?", "options": {"확실하게 50만 원을 더 받기": 1, "동전 앞면이 나오면 100만 원을 더 받고, 뒷면이 나오면 아무것도 못 받기": 3}},
    {"id": "r10", "part": "Part 2.", "q": "10. 당신에게 공짜로 200만 원이 생겼는데, 갑자기 세금이나 벌금으로 일부를 내야 하는 상황입니다. 다음 중 하나를 반드시 선택해야 한다면 무엇을 고르겠습니까?", "options": {"확실하게 50만 원을 세금으로 내기": 1, "동전 앞면이 나오면 100만 원을 내고, 뒷면이 나오면 하나도 안 내기": 3}},
    {"id": "r11", "part": "Part 2.", "q": "11. 유산으로 받은 1억 원을 딱 한 곳에만 넣어야 한다면?", "options": {"MMF/예금": 1, "혼합형 펀드": 2, "주식 포트폴리오": 3, "원자재/금": 4}},
    {"id": "r12", "part": "Part 2.", "q": "12. 당신이 2,000만 원을 투자한다면, 다음 중 어떤 포트폴리오(자산 구성) 비중이 가장 매력적으로 느껴지나요?", "options": {"안전한 예적금 60% + 중위험 자산 30% + 고위험 자산 10%": 1, "안전한 예적금 30% + 중위험 자산 40% + 고위험 자산 30%": 2, "안전한 예적금 10% + 중위험 자산 40% + 고위험 자산 50%": 3}},
    {"id": "r13", "part": "Part 2.", "q": "13. 성공 확률 20%인 친구의 벤처 사업에 투자한다면?", "options": {"투자 안 함": 1, "한 달 치 용돈": 2, "석 달 치 용돈": 3, "반년 치 용돈": 4}}
]
